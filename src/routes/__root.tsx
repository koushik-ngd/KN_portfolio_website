...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Koushik Nagardona — Data Scientist & AI Engineer" },
      ...
      { name: "author", content: "Koushik Nagardona" },
      { property: "og:title", content: "Koushik Nagardona — Data Scientist & AI Engineer" },
      { property: "og:description", content: "Built different. Powered by data." },
